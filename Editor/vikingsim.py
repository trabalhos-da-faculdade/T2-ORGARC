...
programmenu = Menu(menu, background="#171717", fg="white")
menu.add_cascade(label="Programas", menu=programmenu)
programmenu.add_command(label="Novo", command=newprogram)
programmenu.add_command(label="Carregar", command=openprogram)
programmenu.add_command(label="Carregar arquivo adicional", command=openadditionalprogram)
programmenu.add_command(label="Salvar como...", command=saveprogram)
programmenu.add_separator()
programmenu.add_command(label="Compilar", command=assembler)
programmenu.add_separator()
programmenu.add_command(label="Sair", command=root.quit)

machinemenu = Menu(menu, background="#171717", fg="white")
menu.add_cascade(label="Sistema", menu=machinemenu)
machinemenu.add_command(label="Resetar", command=reset)
machinemenu.add_command(label="Parar", command=stop)
machinemenu.add_command(label="Iniciar", command=run)
machinemenu.add_command(label="Passo-A-Passo", command=step)
...
machinemenu.add_command(label="Limpar terminal", command=clear_term)
machinemenu.add_command(label="Memory dump", command=memdump)

topframe = Frame(root,background="#171717")
topframe.pack()
middleframe = Frame(root,background="#171717")
middleframe.pack()
...
textdump = Listbox(middleframe, height=24, width=26, font=('Courier', 11),background="#171717", fg="lightblue")
textdumpscroll = Scrollbar(middleframe, command=textdump.yview)
textdump.configure(yscrollcommand=textdumpscroll.set)
textdump.pack(side=LEFT, fill=BOTH, expand=True)
textdumpscroll.pack(side=LEFT, fill=Y)

textsym = Listbox(middleframe,height=24, width=18, font=('Courier', 11),background="#171717", fg="magenta")
textsymscroll = Scrollbar(middleframe, command=textsym.yview)
textsym.configure(yscrollcommand=textsymscroll.set)
textsym.pack(side=LEFT, fill=BOTH, expand=True)
...
Label(middleframe, textvariable=root.cycle, width=25, font=('Courier', 11), background="#171717", fg="white").pack()
